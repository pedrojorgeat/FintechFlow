...
<div class="container content-container mt-5 mb-5">
    ...
    <form action="${pageContext.request.contextPath}/cadastro" method="post">
        ...
        <div class="mb-4">
            ...
            <input type="text" class="form-control" id="cep" name="cep" maxlength="9" pattern="[0-9]{5}-?[0-9]{3}" placeholder="Ex: 12345-678" required>
        </div>

        <div class="d-grid gap-2">
            <button type="submit" class="btn btn-custom btn-lg">Cadastrar</button>
            <a href="${pageContext.request.contextPath}/login" class="btn btn-outline-secondary btn-lg">Já tenho conta</a>
        </div>
    </form>
</div>
